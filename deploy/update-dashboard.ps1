...
[CmdletBinding()]
param(
    [string]$Zip = '\\192.168.1.10\updates\Shared\DeviceHub\DeviceHub.Dashboard-1.108.0.zip',
    [string]$Sha256 = '15aa9c5c7fdc05f598f44eb699ab4fd431d7a9a6bac37cc8b5f958433125fa03',
