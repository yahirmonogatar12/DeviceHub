...
[CmdletBinding()]
param(
    [string]$Zip = '\\192.168.1.10\updates\Shared\DeviceHub\DeviceHub.Dashboard-1.98.0.zip',
    [string]$Sha256 = 'efe46d66c3e917f9ae8d092f610b2999b665e56ad86ce9a7540558890694ea46',
