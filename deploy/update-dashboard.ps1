...
[CmdletBinding()]
param(
    [string]$Zip = '\\192.168.1.10\updates\Shared\DeviceHub\DeviceHub.Dashboard-1.114.0.zip',
    [string]$Sha256 = 'a801db906de24dbb05314809ff16d34c42a59923a8f85be7289a25bf7587b871',
