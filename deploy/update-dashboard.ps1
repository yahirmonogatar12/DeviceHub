...
[CmdletBinding()]
param(
    [string]$Zip = '\\192.168.1.10\updates\Shared\DeviceHub\DeviceHub.Dashboard-1.92.0.zip',
    [string]$Sha256 = '0393e7b1428604ab0959a858b261e7ec862245179a3d8ad6b9fcdab364b445f2',
