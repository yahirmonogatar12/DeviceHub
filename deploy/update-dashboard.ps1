...
[CmdletBinding()]
param(
    [string]$Zip = '\\192.168.1.10\updates\Shared\DeviceHub\DeviceHub.Dashboard-1.126.0.zip',
    [string]$Sha256 = '767a0a2bad9f8811dd44175a7fd66e50395016a9986645fa481fba9921fc0f02',
