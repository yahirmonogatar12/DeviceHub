...
[CmdletBinding()]
param(
    [string]$Zip = '\\192.168.1.10\updates\Shared\DeviceHub\DeviceHub.Dashboard-1.106.0.zip',
    [string]$Sha256 = 'e00e729c756a6bc239aa2d2c97dcebb8cce3b5248261e0b00835b5c22a50d3af',
