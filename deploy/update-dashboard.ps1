...
[CmdletBinding()]
param(
    [string]$Zip = '\\192.168.1.10\updates\Shared\DeviceHub\DeviceHub.Dashboard-1.104.0.zip',
    [string]$Sha256 = 'a85c3826a748b1156cb688846ab6f5edd169ed0a30c68a2616f38b3eeefa9df2',
