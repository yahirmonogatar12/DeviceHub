...
[CmdletBinding()]
param(
    [string]$Zip = '\\192.168.1.10\updates\Shared\DeviceHub\DeviceHub.Dashboard-1.125.0.zip',
    [string]$Sha256 = 'd922763f2947b46b8ae42ac928625e040027abbf4e9df6a5c87d52a6e5b8fc0f',
