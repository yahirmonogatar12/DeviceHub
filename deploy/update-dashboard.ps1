...
[CmdletBinding()]
param(
    [string]$Zip = '\\192.168.1.10\updates\Shared\DeviceHub\DeviceHub.Dashboard-1.105.0.zip',
    [string]$Sha256 = '3a642a56b257aade79135a71455f5efe8df194375c6a8491d44a72ab1e904cc9',
