...
[CmdletBinding()]
param(
    [string]$Zip = '\\192.168.1.10\updates\Shared\DeviceHub\DeviceHub.Dashboard-1.131.0.zip',
    [string]$Sha256 = '89cff789d7afee7103ca0258db4a8ba94cd99c0119a4c009e1c106b1b7b7e6d2',
