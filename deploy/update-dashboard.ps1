...
[CmdletBinding()]
param(
    [string]$Zip = '\\192.168.1.10\updates\Shared\DeviceHub\DeviceHub.Dashboard-1.116.0.zip',
    [string]$Sha256 = '62e05d007df126dd152ec0f45f311c59dd32db1130f5d2b7c3b13175e6e26757',
