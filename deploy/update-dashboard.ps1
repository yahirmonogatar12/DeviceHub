...
[CmdletBinding()]
param(
    [string]$Zip = '\\192.168.1.10\updates\Shared\DeviceHub\DeviceHub.Dashboard-1.132.0.zip',
    [string]$Sha256 = 'f2515c1a4ac2fb1148b33f08b90abcd3efddb0c0c4d9e151b06414d88b6d4e1f',
