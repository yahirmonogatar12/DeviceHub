...
[CmdletBinding()]
param(
    [string]$Zip = '\\192.168.1.10\updates\Shared\DeviceHub\DeviceHub.Dashboard-1.124.0.zip',
    [string]$Sha256 = '4a1336e8b91029d6d8b9d1502a4332910526392878512ce072659770e5c6c0f3',
