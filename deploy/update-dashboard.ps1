...
[CmdletBinding()]
param(
    [string]$Zip = '\\192.168.1.10\updates\Shared\DeviceHub\DeviceHub.Dashboard-1.133.0.zip',
    [string]$Sha256 = 'e4e2e0dac4524ad274d1bb5e0ab7246094e3fd2193e1d1ab080084f9ecb20dcd',
