...
[CmdletBinding()]
param(
    [string]$Zip = '\\192.168.1.10\updates\Shared\DeviceHub\DeviceHub.Dashboard-1.113.0.zip',
    [string]$Sha256 = '90e773e428a13f0312069001a0c7ebd14f528bac481145f2a0e14f9bfc363b8a',
