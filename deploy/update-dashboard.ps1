...
[CmdletBinding()]
param(
    [string]$Zip = '\\192.168.1.10\updates\Shared\DeviceHub\DeviceHub.Dashboard-1.96.0.zip',
    [string]$Sha256 = 'e54b1bd43e231f3d2430d2359dc2df9660ca6fd764ccb543b80dc32258cad07a',
