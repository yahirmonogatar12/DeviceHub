...
[CmdletBinding()]
param(
    [string]$Zip = '\\192.168.1.10\updates\Shared\DeviceHub\DeviceHub.Dashboard-1.78.0.zip',
    [string]$Sha256 = '1ccce041ae042c9c5f514505c39856cb04ad15b8ae852767a672aa8c86f9d419',
