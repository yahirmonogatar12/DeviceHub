...
[CmdletBinding()]
param(
    [string]$Zip = '\\192.168.1.10\updates\Shared\DeviceHub\DeviceHub.Dashboard-1.123.0.zip',
    [string]$Sha256 = 'b6d1c1db87cfb9517e8f9e4c1f2f7c91140b15869ef024a5167b2a483ccce74f',
