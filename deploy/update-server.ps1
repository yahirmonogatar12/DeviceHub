...
[CmdletBinding()]
param(
    [string]$Zip = '\\192.168.1.10\updates\Shared\DeviceHub\DeviceHub.Server-1.102.0.zip',
    [string]$Sha256 = '19e1fb4f4695d9e41e794e2516f1579ebbbd0390c24d0eed7c3a3e3db2c5d113',
