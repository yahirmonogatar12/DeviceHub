...
[CmdletBinding()]
param(
    [string]$Zip = '\\192.168.1.10\updates\Shared\DeviceHub\DeviceHub.Server-1.112.0.zip',
    [string]$Sha256 = 'ba40209a23500c8235547bbc2ef5197ccee8a9da01a565f51b7a72564d8222e3',
