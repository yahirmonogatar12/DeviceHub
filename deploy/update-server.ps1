...
[CmdletBinding()]
param(
    [string]$Zip = '\\192.168.1.10\updates\Shared\DeviceHub\DeviceHub.Server-1.109.0.zip',
    [string]$Sha256 = '97f001437e453f0b9ea934fb0379f05a096324b26675312319f9b7e24a0269a1',
