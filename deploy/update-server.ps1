...
[CmdletBinding()]
param(
    [string]$Zip = '\\192.168.1.10\updates\Shared\DeviceHub\DeviceHub.Server-1.94.0.zip',
    [string]$Sha256 = '96d69d69da9ed5b42972d067956f57e41a9fbcfd7a42e41a457689b1f57d7f40',
